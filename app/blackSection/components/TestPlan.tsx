...
export default function TestPlan({
  ...
  const remarketingUrl = 'https://wa.me/5511934748273/?text=Olá%20BK%20Arts, estou interessado no Plano Test, gostaria de adquirir a oferta de Black Friday!'
  ...
  return (
    <SubCard
      ...
      value={remarketing ? '277,00' : '347,00'}
      className="flex"
      oldValue='347,00'
      tag="Custo Benefício!"
    >
