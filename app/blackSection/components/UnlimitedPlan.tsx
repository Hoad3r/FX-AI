...
export default function UnlimitedPlan({
  ...
  const remarketingUrl = 'https://wa.me/5511934748273/?text=Olá%20BK%20Arts, estou interessado no Plano Unlimited, gostaria de adquirir a oferta de Black Friday!'
  ...
  return (
    <SubCard
      ...
      value={remarketing ? '797,00' : '997,00'}
      oldValue='997,00'
      className="bg-[#e11d4707]"
      tag="Mais Vendido!"
    >
