        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/5511944405779" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#C4AC68]">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="tel:+5511944405779" className="hover:text-[#C4AC68] transition-colors">
                  +55 11 94440-5779
                </a>
              </li>
            </ul>
