  ...
  return (
    <div className="font-sans w-full pb-16 pt-36 md:pb-24 lg:pb-32 md:pt-24 lg:pt-48 xl:pt-56 2xl:pt-64 flex justify-between gap-8 items-center flex-col relative z-0">
      <div className="z-50 flex flex-col items-center justify-center gap-5 px-6 text-center lg:gap-6">
        <LandingBackground />
        <h1
          className={`bg-gradient-to-b from-black to-[#555] dark:from-white dark:to-[#aaa] ${style.gradients_hero} ${style.text_balance} font-extrabold tracking-[-0.04em] leading-none text-[40px] md:text-5xl lg:text-[80px] max-w-lg md:max-w-xl lg:max-w-6xl text-center text-transparent pb-3`}
        >
        ...
        Somos um time de especialistas em IA e automações para mercado digital, nossa missão é poupar seu tempo e potencializar suas vendas!
        </p>
        <p className="font-space-grotesk leading-snug dark:text-[#FFFFFFB2] text-[#000000a0] text-[20px] lg:text-xl max-w-md md:max-w-xl lg:max-w-[640px] text-center">
      ...
      <div className="z-50 flex flex-col items-center w-full max-w-xs gap-5 px-6">
        <div className="flex flex-col w-full gap-3 md:!flex-row">
          ...
          {fb ?
            ...
            <a href='#planos' className="text-center w-full block py-3 min-w-[120px] text-base font-medium no-underline text-white border-transparent bg-[#C4AC68] rounded md:leading-6 transition-all duration-300 ">
                Veja nossos planos
            </a>
          : 
