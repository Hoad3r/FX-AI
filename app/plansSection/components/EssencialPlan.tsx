...
export default function ExperiencePlan({  
  ...
  remarketing?: boolean
  fb?: boolean }) {
  const creditUrl = 'https://wa.me/5583989027272/?text=Olá%20Fx, gostaria de saber mais sobre o plano Pro!'
  const pixUrl = 'https://wa.me/5583989027272/?text=Olá%20Fx, gostaria de saber mais sobre o plano Pro!'
  const fbUrl = 'https://wa.me/55583989027272/?text=Olá%20Fx, gostaria de saber mais sobre o plano Pro!'
  return (
    <SubCard
      title="Pro"
      period="Mês"
