...
export default function UnlimitedProPlan({
  ...
  const remarketingUrl = 'https://wa.me/5511934748273/?text=Olá%20BK%20Arts, estou interessado no Plano Unlimited Pro, sou assinante do BK Reviews e quero meu desconto de 20%!'
