...
export default function ExperiencePlan({
  ...
  const remarketingUrl = 'https://wa.me/5511934748273/?text=Olá%20BK%20Arts, estou interessado no Plano Experience, sou assinante do BK Reviews e quero meu desconto de 20%!'
  const kiwifyUrl = 'https://pay.kiwify.com.br/GtxTuCR'
