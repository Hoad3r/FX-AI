...
import UnicoPlan from "./components/UnicoPlan"
...
export default function RemarketingSectionKiwify({ title, pix }: RemarketingSectionProps) {
  return (
    <section
      id="planos"
    ...
    >
      ...
      <div className="flex w-full flex-col md:flex-row items-center justify-center gap-24 sm:gap-8 pb-9">
        <UnicoPlan pix={pix} remarketing={true} />
